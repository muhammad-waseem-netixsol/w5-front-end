...
const AddProduct = () => {
  ...
  const navigate = useNavigate();
    const [editMode, setEditMode] = useState(location.state !== null ? true : false);
    ...
    return (
        <div className=''>
           ...
           <form className='max-w-[500px] flex gap-3 flex-col mx-auto' onSubmit={onAddNewProduct}>
                <input className='outline-none border py-2 px-2 block w-full' type="text" placeholder='Enter title...' onChange={handleInputChange} value={product.title} name='title'/>
